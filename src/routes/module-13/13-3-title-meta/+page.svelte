...
<style>
  ...
  .serp { margin-block-start: var(--space-md); padding: var(--space-md); border: 1px solid var(--color-border); border-radius: var(--radius-md); background: oklch(98% 0 0); display: flex; flex-direction: column; gap: var(--space-xs); }
